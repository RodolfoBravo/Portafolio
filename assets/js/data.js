  ...
  return [
    {
      ...
      es: {
        ...
        problem: 'El equipo de soporte de una plataforma B2B consultaba documentación repartida en 14 fuentes distintas. Cada respuesta tomaba 12 minutos y variaba según quién la contestara.',
        ...
        impact: [
          ...
          '96% de respuestas con cita verificable',
          '+8,000 consultas al mes'
        ],
      ...
      en: {
        ...
        problem: 'The support team at a B2B platform was searching documentation spread across 14 different sources. Each answer took 12 minutes and varied depending on who wrote it.',
        ...
        impact: [
          'Response time −75%',
          '96% of answers carry a verifiable citation',
          '8,000+ queries per month'
        ],
    ...
    },
    {
      ...
      es: {
        ...
        problem: 'Un proceso interno de 9 pasos manuales entre el CRM, correo y hojas de cálculo consumía 20 horas por semana del equipo de operaciones.',
        ...
        impact: [
          '17 horas por semana recuperadas',
          '88% de ejecuciones sin intervención humana',
      ...
      en: {
        ...
        problem: 'An internal 9-step manual process spanning the CRM, email, and spreadsheets consumed 20 hours per week from the operations team.',
        ...
        impact: [
          '17 hours per week recovered',
          '88% of runs completed with no human intervention',
    ...
    },
    {
      ...
      en: {
        ...
        solution: 'Golden dataset of 400 representative cases; automated evaluations for accuracy, groundedness, and format conformance; LLM-as-judge with an explicit rubric for subjective criteria; a CI gate that blocks deployment when the score drops below threshold; dashboards for p95 latency, cost per request, and error rate per version.',
        impact: [
          'Regressions caught before production',
          'Production incidents −65%',
    ...
    },
    {
      ...
      es: {
        ...
        impact: [
          'Costo de IA por usuario −45%',
          'La feature pasó a representar el 18% del MRR',
    ...
    },
    {
      ...
      es: {
        ...
        problem: '5,000 documentos al mes (facturas y órdenes de compra) capturados a mano, con 7% de error de captura y un rezago constante.',
        ...
        impact: [
          '92% de documentos procesados sin intervención',
          'Tiempo por documento de 6 min a 40 s',
          'Error de captura −85%'
        ],
      ...
      en: {
        ...
        problem: '5,000 documents per month (invoices and purchase orders) captured by hand, with a 7% capture error rate and a constant backlog.',
        ...
        impact: [
          '92% of documents processed with no intervention',
          'Time per document from 6 min to 40 s',
          'Capture errors −85%'
        ],
    ...
    },
    {
      ...
      es: {
        ...
        problem: 'Más de 300 mensajes diarios en WhatsApp e Instagram quedaban sin atender fuera de horario, con 35% de leads perdidos por falta de respuesta.',
        ...
        impact: [
          'Primera respuesta en menos de 5 segundos, 24/7',
          '78% de conversaciones resueltas sin humano',
      ...
      en: {
        ...
        problem: '300+ daily messages on WhatsApp and Instagram went unanswered outside business hours, losing 35% of leads to slow response.',
        ...
        impact: [
          'First response under 5 seconds, 24/7',
          '78% of conversations resolved without a human',
          'Qualified leads +40%'
        ],
