(function (root, factory) {
  ...
  var DICT = {
    es: {
      ...
      'hero.kicker': 'Fullstack AI Engineer · 7 años construyendo software · [XX] en sistemas de IA',
      'hero.roleLabel': 'Rol',
      ...
      'production.nodeTools': 'Herramientas · function calling',
      'production.nodeLlm': 'LLM + modelo de respaldo',
    ...
    en: {
      ...
      'hero.kicker': 'Fullstack AI Engineer · 7 years building software · [XX] in AI systems',
      'hero.roleLabel': 'Role',
      ...
      'production.nodeTools': 'Tools · function calling',
      'production.nodeLlm': 'LLM + fallback model',
